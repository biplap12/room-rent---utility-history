package com.rentutilitymanager.ui.theme
...
private val DarkColorScheme = darkColorScheme(
    primary = PrimaryCobaltDark,
    onPrimary = OnPrimaryCobaltDark,
    primaryContainer = PrimaryContainerCobaltDark,
    onPrimaryContainer = OnPrimaryContainerCobaltDark,
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = OnPrimaryCobalt,
    primaryContainer = PrimaryContainerCobalt,
    onPrimaryContainer = OnPrimaryContainerCobalt,
...
fun RoomRentTheme(
    ...
    dynamicColor: Boolean = false, // Keep consistent crafted brand palette
